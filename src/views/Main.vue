...
<template>
  <main class="about">
    <About :sectionLink="getLinkByKey('about')" />
    <Skills :sectionLink="getLinkByKey('skills')" :navMenuLangPage="navMenuLangPage" />
    <Achievements :sectionLink="getLinkByKey('achievements')" :navMenuLangPage="navMenuLangPage" />
    <Contacts :sectionLink="getLinkByKey('contacts')" :navMenuLangPage="navMenuLangPage" />
  </main>
</template>
